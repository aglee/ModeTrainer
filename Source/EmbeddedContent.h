...
<li><strong>Playback Speed Control</strong>: Adjust tempo from 0.5x (slow) to 2.0x (fast) for different skill levels</li>
...
<li><strong>Change Speed</strong>: Use the "Speed" slider (0.5x-2.0x) to adjust playback tempo</li>
...
<li>A C++17 compatible compiler (Xcode on macOS, Visual Studio on Windows, GCC/Clang on Linux)</li>
<li>Git (for downloading JUCE automatically)</li>
</ul>
...
<li>Create a build directory and navigate to it:
<pre><code>mkdir build
cd build</code></pre></li>
<li>Configure the project with CMake:
<pre><code>cmake ..</code></pre></li>
<li>Build the project:
<pre><code>cmake --build .</code></pre></li>
</ol>

<p>The application will be built in the build directory. On macOS, look for <code>ModeTrainer.app</code>.</p>

<h3>Dependencies</h3>

<p>This project uses JUCE (version 8.0.4), which will be automatically downloaded during the CMake configuration process. No manual JUCE installation is required.</p>
